...
#SBATCH --job-name=r3bnbnu-NTuple
#SBATCH --time=8:00:00
#SBATCH --ntasks=1
...
#SBATCH --error=err/griderr_ntuple_mcc9_v40_bnb_nu_overlay_500k_CV_run3b_sub00.%A.%a.node%N.err
#SBATCH --output=log/stdout_ntuple_mcc9_v40_bnb_nu_overlay_500k_CV_run3b_sub00.%A.%a.node%N.log
