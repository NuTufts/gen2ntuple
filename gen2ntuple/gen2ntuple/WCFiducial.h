#ifndef __GEN2NTUPLE_WCFIDUCIAL_H__
...
class WCFiducial {
  ...
  private:
    ...
    double _current_boundary_dis_cut;
    ...
    void initialize_arrays(double boundary_dis_cut){
      ...
      _current_boundary_dis_cut = boundary_dis_cut;
  ...
  private:
    ...
    static WCFiducial* _gWCFiducial;
  ...
  public:
    ...
    float getCurrentBoundary() { return _current_boundary_dis_cut; };

    static WCFiducial* getME( double boundary_cm=-1.0 );
