...
apptainer exec --bind ${BINDING} ${CONTAINER} bash -c "cd ${REPO_DIR} && ./tufts_run_flash_prediction.sh ${RECOFILELIST} ${TRUTHFILELIST} ${NFILES} ${MCFLAG}"
