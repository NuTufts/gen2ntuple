...
def parse_merged_dl_filelist( mdlfiles ):
  ...
  # looks like: /cluster/tufts/wongjiradlab/larbys/data/mcc9/mcc9_v29e_dl_run3_G1_extbnb_dlana/data/mcc9_v29e_dl_run3_G1_extbnb_dlana/merged_dlana_d9679e9b-3be3-4411-bc25-6e2cea860827.root
  filedict = {}
...
def getFiles(mdlTag, kpsfiles, mdlfiles):
  ...
  for kpsfile in kpsfiles:
    ...
    #  dlrecofile = os.path.basename(line.replace("\n",""))
